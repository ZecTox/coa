...
with col1.form("coa_form"):
    ...
    product_name = st.text_input("Product Name", placeholder="X")
    product_code = st.text_input("Product Code", placeholder="X")
    batch_no = st.text_input("Batch No.", placeholder="X")
    manufacturing_date = st.text_input("Date of Manufacturing", placeholder="X")
    reanalysis_date = st.text_input("Date of Reanalysis", placeholder="X")
    botanical_name = st.text_input("Botanical Name", placeholder="X")
    extraction_ratio = st.text_input("Extraction Ratio", placeholder="X")
    solvent = st.text_input("Extraction Solvents", placeholder="X")
    plant_part = st.text_input("Plant Parts", placeholder="X")
    cas_no = st.text_input("CAS No.", placeholder="X")
    chemical_name = st.text_input("Chemical Name", placeholder="X")
    quantity = st.text_input("Quantity", placeholder="X")
    ...
    loss_on_drying_result = st.text_input("Result for Loss on Drying", placeholder="X")
    ...
    moisture_result = st.text_input("Result for Moisture", placeholder="X")
    moisture_method = st.text_input("Method for Moisture", value="USP<921>")

    particle_size_spec = st.text_input("Specification for Particle Size", placeholder="X")
    particle_size_result = st.text_input("Result for Particle Size", placeholder="X")
    ...
    ash_contents_result = st.text_input("Result for Ash Contents", placeholder="X")
    ...
    residue_on_ignition_result = st.text_input("Result for Residue on Ignition", placeholder="X")
    ...
    bulk_density_result = st.text_input("Result for Bulk Density", placeholder="X")
    ...
    tapped_density_result = st.text_input("Result for Tapped Density", placeholder="X")
    tapped_density_method = st.text_input("Method for Tapped Density", value="USP<616>")
    
    solubility_spec = st.text_input("Specification for Solubility", placeholder="X")
    solubility_result = st.text_input("Result for Solubility", placeholder="X")
    solubility_method = st.text_input("Method for Solubility", value="USP<1236>")
    
    ph_spec = st.text_input("Specification for pH", placeholder="X")
    ph_result = st.text_input("Result for pH", placeholder="X")
    ph_method = st.text_input("Method for pH", value="USP<791>")
    
    chlorides_nacl_spec = st.text_input("Specification for Chlorides of NaCl", placeholder="X")
    chlorides_nacl_result = st.text_input("Result for Chlorides of NaCl", placeholder="X")
    chlorides_nacl_method = st.text_input("Method for Chlorides of NaCl", value="USP<221>")
    
    sulphates_spec = st.text_input("Specification for Sulphates", placeholder="X")
    sulphates_result = st.text_input("Result for Sulphates", placeholder="X")
    sulphates_method = st.text_input("Method for Sulphates", value="USP<221>")
    
    fats_spec = st.text_input("Specification for Fats", placeholder="X")
    fats_result = st.text_input("Result for Fats", placeholder="X")
    fats_method = st.text_input("Method for Fats", value="USP<731>")
    
    protein_spec = st.text_input("Specification for Protein", placeholder="X")
    protein_result = st.text_input("Result for Protein", placeholder="X")
    protein_method = st.text_input("Method for Protein", value="Kjeldahl")
    
    total_ig_g_spec = st.text_input("Specification for Total IgG", placeholder="X")
    total_ig_g_result = st.text_input("Result for Total IgG", placeholder="X")
    total_ig_g_method = st.text_input("Method for Total IgG", value="HPLC")
    
    sodium_spec = st.text_input("Specification for Sodium", placeholder="X")
    sodium_result = st.text_input("Result for Sodium", placeholder="X")
    sodium_method = st.text_input("Method for Sodium", value="ICP-MS")
    
    gluten_spec = st.text_input("Specification for Gluten", value="NMT X")
    gluten_result = st.text_input("Result for Gluten", placeholder="X")
    ...
    lead_result = st.text_input("Result for Lead", placeholder="X")
    ...
    cadmium_result = st.text_input("Result for Cadmium", placeholder="X")
    ...
    arsenic_result = st.text_input("Result for Arsenic", placeholder="X")
    ...
    mercury_result = st.text_input("Result for Mercury", placeholder="X")
    mercury_method = st.text_input("Method for Mercury", value="ICP-MS")

    st.subheader("Assays")
    assays_spec = st.text_input("Specification for Assays", placeholder="X")
    assays_result = st.text_input("Result for Assays", placeholder="X")
    assays_method = st.text_input("Method for Assays", placeholder="X")
    ...
    residual_solvent_spec = st.text_input("Specification for Residual Solvent", placeholder="X")
    residual_solvent_result = st.text_input("Result for Residual Solvent", value="Compiles")
    residual_solvent_method = st.text_input("Method for Residual Solvent", placeholder="X")
    ...
    coliforms_result = st.text_input("Result for Coliforms", placeholder="X")
